    ...
    const getContent = () => {
        return (
            <ScrollView
                ...
                <Text style={[tw` text-sm font-medium text-right`, { color: 'black' }]}>Saldo Pendiente: <Text style={[tw` text-base font-bold`, { color: '#FF7A00' }]}>$812.00</Text></Text>
                <View style={tw`flex-row items-start my-4`}>
                ...
                <View style={tw`flex-row my-10 justify-around items-center `}>
                    ...
                    /><Button
                        ...
                        title="Siguiente"
                        onPress={() => navigation.navigate('NewRegisterStep4')}
                    />
